...
export const state: () => <This, T>(value: ClassAccessorDecoratorTarget<This, T>, context: ClassAccessorDecoratorContext<This, T>) => void;
export const attribute: <T>(name: string, options?: {
 ...
 */
declare function stop$1(runner: ReactiveEffectRunner): void;
/**
...
export type ToRef<T> = IfAny<T, Ref<T>, [
	T
] extends [
	Ref
] ? T : Ref<T>>;
...
export type DistributeRef<T> = T extends Ref<infer V, unknown> ? V : T;
